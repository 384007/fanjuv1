...
const TOPIC_ALLOWLIST = {
  ...
  pet: ["pet", "cat", "dog"],
  devtools: ["git", "github", "gitlab", "webpack", "vite", "eslint", "typescript", "javascript", "python", "rust", "docker", "kubernetes", "pipeline", "cicd", "devops", "npm", "yarn", "pnpm", "react", "vue", "angular", "node", "deno", "bun", "linux", "macos", "windows", "vscode", "vim", "neovim", "jetbrains", "figma", "notion", "slack", "discord", "agile", "scrum", "sprint", "kanban", "jira", "trello"],
  tech: ["git", "github", "gitlab", "webpack", "vite", "eslint", "typescript", "javascript", "python", "rust", "docker", "kubernetes", "pipeline", "devops", "npm", "react", "vue", "node", "linux", "vscode"],
