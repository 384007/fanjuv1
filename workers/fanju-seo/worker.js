...
const STATIC_HEADER = '<header class="sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur-xl"><div class="mx-auto flex h-16 max-w-[1400px] items-center justify-between px-4 md:px-8"><a href="/" class="flex items-center gap-3"><div class="relative flex h-8 w-8 items-center justify-center"><img src="/favicon.svg?v=20260603" alt="饭局 Fanju" class="h-8 w-8 object-contain"/></div><div class="flex flex-col leading-none"><span class="font-serif text-base font-medium tracking-wide text-foreground">FANJU</span><span class="font-mono text-[9px] tracking-[0.25em] text-muted-foreground uppercase">同频饭局</span></div></a><nav class="hidden items-center gap-7 md:flex"><a href="/product-map" class="font-mono text-[11px] tracking-[0.2em] text-muted-foreground uppercase transition-colors hover:text-foreground">产品</a><a href="/cities" class="font-mono text-[11px] tracking-[0.2em] text-muted-foreground uppercase transition-colors hover:text-foreground">城市</a><a href="/categories" class="font-mono text-[11px] tracking-[0.2em] text-muted-foreground uppercase transition-colors hover:text-foreground">类型</a><a href="/host-tools" class="font-mono text-[11px] tracking-[0.2em] text-muted-foreground uppercase transition-colors hover:text-foreground">主办方</a><a href="/market" class="font-mono text-[11px] tracking-[0.2em] text-muted-foreground uppercase transition-colors hover:text-foreground">市场</a></nav><div class="flex items-center gap-3"><div class="flex items-center border border-border/80 bg-secondary/40 p-0.5"><a href="/en/what-is-fanju" class="px-2.5 py-1 font-mono text-[10px] tracking-[0.2em] uppercase transition-colors text-muted-foreground hover:text-foreground">EN</a><a href="/what-is-fanju" class="px-2.5 py-1 font-mono text-[10px] tracking-[0.2em] uppercase transition-colors bg-accent text-accent-foreground">CN</a></div><a href="/create" class="hidden items-center gap-1.5 border border-border/80 bg-secondary/40 px-3 py-2 font-mono text-[11px] tracking-[0.2em] text-foreground uppercase transition-colors hover:border-accent/60 hover:text-accent sm:flex">创建</a><a href="/invite" class="group flex items-center gap-1.5 bg-accent px-3.5 py-2 font-mono text-[11px] tracking-[0.2em] text-accent-foreground uppercase transition-colors hover:bg-accent/90"><span>邀请</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right h-3 w-3 transition-transform group-hover:translate-x-0.5" aria-hidden="true"><path d="m9 18 6-6-6-6"></path></svg></a></div></div></header>'

const STATIC_FOOTER = '<footer id="about" class="relative bg-background"><div class="mx-auto max-w-[1400px] px-4 pt-16 pb-10 md:px-8 md:pt-24"><div class="grid grid-cols-2 gap-10 md:grid-cols-12"><div class="col-span-2 md:col-span-4"><a href="/" class="flex items-center gap-3"><div class="relative flex h-9 w-9 items-center justify-center border border-accent/40 bg-gradient-to-br from-primary/40 to-background"><span class="font-serif text-base font-semibold text-accent">饭</span></div><div class="flex flex-col leading-none"><span class="font-serif text-lg font-medium tracking-wide text-foreground">FANJU</span><span class="font-mono text-[9px] tracking-[0.25em] text-muted-foreground uppercase">同频饭局 · v1.0</span></div></a><p class="mt-6 max-w-md font-serif text-2xl text-foreground italic md:text-3xl">一顿饭，认识同频的人。</p><p class="mt-6 max-w-md text-xs leading-relaxed text-muted-foreground">不展示虚假报名人数 · 主办方招募中</p></div><div class="md:col-span-2"><h4 class="font-mono text-[10px] tracking-[0.25em] text-accent uppercase">· <!-- -->产品入口</h4><ul class="mt-5 grid gap-3"><li><a href="/create" class="text-sm text-muted-foreground transition-colors hover:text-foreground">创建饭局</a></li><li><a href="/invite" class="text-sm text-muted-foreground transition-colors hover:text-foreground">邀请链接</a></li><li><a href="/explore" class="text-sm text-muted-foreground transition-colors hover:text-foreground">发现饭局</a></li><li><a href="/rsvp" class="text-sm text-muted-foreground transition-colors hover:text-foreground">报名状态</a></li><li><a href="/features" class="text-sm text-muted-foreground transition-colors hover:text-foreground">功能目录</a></li><li><a href="/templates" class="text-sm text-muted-foreground transition-colors hover:text-foreground">模板</a></li><li><a href="/host-console" class="text-sm text-muted-foreground transition-colors hover:text-foreground">主办方控制台</a></li></ul></div><div class="md:col-span-2"><h4 class="font-mono text-[10px] tracking-[0.25em] text-accent uppercase">· <!-- -->功能入口</h4><ul class="mt-5 grid gap-3"><li><a href="/guests" class="text-sm text-muted-foreground transition-colors hover:text-foreground">嘉宾名单</a></li><li><a href="/polls" class="text-sm text-muted-foreground transition-colors hover:text-foreground">时间投票</a></li><li><a href="/questions" class="text-sm text-muted-foreground transition-colors hover:text-foreground">报名问题</a></li><li><a href="/table" class="text-sm text-muted-foreground transition-colors hover:text-foreground">餐桌说明</a></li><li><a href="/photos" class="text-sm text-muted-foreground transition-colors hover:text-foreground">饭局相册</a></li><li><a href="/matching" class="text-sm text-muted-foreground transition-colors hover:text-foreground">单身匹配</a></li><li><a href="/cohosts" class="text-sm text-muted-foreground transition-colors hover:text-foreground">共同主办</a></li><li><a href="/reminders" class="text-sm text-muted-foreground transition-colors hover:text-foreground">提醒</a></li><li><a href="/comments" class="text-sm text-muted-foreground transition-colors hover:text-foreground">留言</a></li><li><a href="/capacity" class="text-sm text-muted-foreground transition-colors hover:text-foreground">人数状态</a></li><li><a href="/calendar" class="text-sm text-muted-foreground transition-colors hover:text-foreground">日历</a></li><li><a href="/checkin" class="text-sm text-muted-foreground transition-colors hover:text-foreground">到场</a></li><li><a href="/visibility" class="text-sm text-muted-foreground transition-colors hover:text-foreground">可见性</a></li><li><a href="/feedback" class="text-sm text-muted-foreground transition-colors hover:text-foreground">反馈</a></li></ul></div><div class="md:col-span-2"><h4 class="font-mono text-[10px] tracking-[0.25em] text-accent uppercase">· <!-- -->AI 搜索</h4><ul class="mt-5 grid gap-3"><li><a href="/what-is-fanju" class="text-sm text-muted-foreground transition-colors hover:text-foreground">饭局是什么</a></li><li><a href="/rules" class="text-sm text-muted-foreground transition-colors hover:text-foreground">参加规则</a></li><li><a href="/hosts" class="text-sm text-muted-foreground transition-colors hover:text-foreground">主办方招募</a></li><li><a href="/cities" class="text-sm text-muted-foreground transition-colors hover:text-foreground">全部城市</a></li><li><a href="/categories" class="text-sm text-muted-foreground transition-colors hover:text-foreground">全部类型</a></li><li><a href="/en/features" class="text-sm text-muted-foreground transition-colors hover:text-foreground">英文功能目录</a></li><li><a href="/sitemap.xml" class="text-sm text-muted-foreground transition-colors hover:text-foreground">站点地图</a></li><li><a href="/llms.txt" class="text-sm text-muted-foreground transition-colors hover:text-foreground">LLM 文件</a></li></ul></div></div><div class="mt-16 h-px gold-hairline"></div><div class="mt-6 flex flex-col items-start justify-between gap-3 font-mono text-[10px] tracking-[0.22em] text-muted-foreground uppercase md:flex-row md:items-center"><div>© 2026 饭局 Fanju · 保留所有权利</div><div class="flex items-center gap-2"><span class="live-dot inline-block h-1.5 w-1.5 rounded-full bg-accent"></span><span>fanju.app · 产品 · 功能 · 饭局社交</span></div></div></div></footer>'
...
<head>
  ...
  <link rel="icon" href="/favicon.svg?v=20260603" type="image/svg+xml">
  <script type="application/ld+json">${escapeJsonForHtml(jsonLd)}</script>
  <style>
...
async function readyArticleLinksForCity(route, currentPath, isEn, env) {
  ...
  try {
    ...
    return rows
      .filter((row) => {
        const path = normalizePath(row.canonical_path || "")
        return /^\/(?:en\/)?city\/[^/]+\/[^/]+$/.test(path) && path !== normalizePath(currentPath)
      })
      .map((row) => ({
        href: normalizePath(row.canonical_path || ""),
        label: stripTags(row.title || "").replace(/\|.*$/, "").trim() || row.canonical_path,
      }))
      .slice(0, 6)
  } catch {
    return []
