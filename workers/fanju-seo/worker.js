...
<head>
  ...
  <style>
    *,*::before,*::after{box-sizing:border-box}
    :root{
      --bg:#0a0a0a;--fg:#fafafa;--muted:#a3a3a3;--border:#262626;--card:#141414;
      --accent:#8b1e3f;--accent-fg:#fafafa;--secondary:#1a1a1a;
    ...
    .topbar-right{font-family:var(--font-mono);font-size:11px;letter-spacing:.18em;color:var(--muted);text-transform:uppercase}
    ...
    .article-body ul,
    .article-body ol{padding-left:1.5rem;margin:.75rem 0}
...
<div class="topbar">
  <div class="topbar-inner">
    <div class="topbar-left">
      ...
      <span>${isZh ? "饭局 · 全球同频饭局" : "FANJU · GLOBAL SOCIAL DINING"}</span>
    </div>
    <div class="topbar-right">${isZh ? "饭局 · 全球同频饭局" : "FANJU · GLOBAL SOCIAL DINING"}</div>
  </div>
</div>
  ...
  <div class="header-inner">
    <a href="/" class="brand">
      ...
      <div class="brand-text">
        <span class="brand-name">FANJU</span>
        <span class="brand-sub">${isZh ? "同频饭局" : "Chinese Social Dining"}</span>
      </div>
    </a>
    <nav class="header-nav">
      ${isZh
        ? `<a href="/product-map">产品</a><a href="/cities">城市</a><a href="/categories">类型</a><a href="/host-tools">主办方</a><a href="/market">市场</a>`
        : `<a href="/product-map">Product</a><a href="/en/cities">Cities</a><a href="/en/categories">Categories</a><a href="/host-tools">Hosts</a><a href="/market">Market</a>`
      }
    </nav>
...
<nav class="breadcrumb" aria-label="breadcrumb">
  <div class="breadcrumb-inner">
    <ol>
      <li><a href="/">${isZh ? "饭局 Fanju" : "Fanju"}</a></li>
      <li><span aria-hidden>/</span><span>${escapeHtml(article.title)}</span></li>
    </ol>
...
<section class="hero">
  <div class="hero-inner">
    <div class="eyebrow">
      ...
      <span>${isZh ? "饭局文章" : "Fanju Article"}</span>
    </div>
