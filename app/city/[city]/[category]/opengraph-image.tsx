...
export const alt = "饭局 Fanju 城市饭局"
export const size = {
  width: 1200,
  height: 630,
}
...
export default async function Image({ params }: ImageProps) {
  ...
  const cityName = city?.name || slugLabel(citySlug)
  const categoryName = category?.name || slugLabel(categorySlug)
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "18px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ color: "#786557", fontSize: "20px" }}>饭局 Fanju</div>
            </div>
          </div>
          <div style={{ color: "#8b4f2a", fontSize: "24px", fontWeight: 700 }}>城市饭局指南</div>
        </div>
