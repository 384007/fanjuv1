...
A dinner in Sea Point should feel different from one in Khayelitsha, not just in menu but in tone, timing, and conversation. The guest list plays a crucial role in shaping that atmosphere. Fanju’s model limits dinners to six to eight guests, ensuring that no one is lost in a crowd and that quieter voices have space. This scale allows for a mix of locals, expats, students, and professionals who might not cross paths otherwise, but only if the host sets clear expectations. A university student in Mowbray might host a meal focused on budget cooking, attracting others navigating similar constraints.
