...
Not every dinner needs to be accepted. In fact, the ability to decline without guilt is part of what makes the Fanju model work in Perth. Teachers are accustomed to saying yes—yes to extra duties, yes to events, yes to helping out. The app introduces a new norm: it’s acceptable to browse dinners, read the details, and choose nothing. Hosts don’t see who declines. There’s no follow-up, no pressure. This protects the integrity of the yes when it comes.
