---
slug: "en-singapore-consumer-founder-dinner"
canonicalPath: "/en/city/singapore/consumer-founder-dinner"
...
After dinner, there’s no group chat, no LinkedIn requests, no follow-up email from the app. The Fanju app doesn’t suggest connections or prompt feedback. It leaves the next move undefined. That silence is deliberate. In a city where every interaction risks being optimized into a pipeline, the absence of a “next step” is the point. You’re not expected to convert the evening into a partnership, a hire, or a deal. You’re just expected to have been there.
...
##### The opening signal that separates a real Singapore Consumer Founder Dinner table from a random one

The first five minutes tell you everything. When the host doesn’t jump into introductions or force a topic, when they let the table settle into the sound of spoons clinking and people ordering, that’s the signal. A real table doesn’t start with a prompt. It starts with presence. Someone might mention the rain, another might comment on the chili level. The conversation unfolds, not performs. If the host immediately asks everyone to share their startup and traction, it’s not a Fanju-style dinner. The real ones breathe.

###### Leaving on your own terms at a Singapore Consumer Founder Dinner dinner
...
####### After the Singapore Consumer Founder Dinner dinner: one action that matters

Send one message. Not to everyone. Just one. To the person whose comment stayed with you. Not to network. Not to follow up. Just to say, “I thought about what you said about feedback loops. It stayed with me.” That’s enough. It keeps the human thread alive without turning it into a transaction. The app doesn’t prompt it. You do it because it feels right.

######## What repeat Singapore Consumer Founder Dinner guests notice that first-timers miss
