...
class Adapter(BaseAdapter):
    ...
    async def publish(self, markdown_content: str) -> dict:
        ...
        async with async_playwright() as p:
            ...
            await page.goto("https://baijiahao.baidu.com/builder/rc/edit?type=news", wait_until="networkidle")
            await self._random_delay(3, 5)

            await page.locator("input[placeholder*='标题']").first.fill(title)
            editor = page.locator(".cheditor-content, [contenteditable=true]").first
            await editor.click()
