...
class Adapter(BaseAdapter):
    ...
    async def publish(self, markdown_content: str) -> dict:
        ...
        async with async_playwright() as p:
            ...
            await page.goto("https://www.jianshu.com/writer", wait_until="networkidle")
            await self._random_delay(2, 3)

            title_el = page.locator("input[placeholder*='标题']").first
            ...
            await page.locator("a:has-text('发布文章'), button:has-text('发布')").first.click()
